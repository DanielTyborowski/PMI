        ...
        <div class="w3-row-padding w3-margin-top">
            ...
            <div class="w3-third w3-margin-bottom">
                <a href="{{ route('resource.index') }}" class="w3-text-black">
                    <div class="w3-card w3-hover-shadow w3-padding-32 w3-center">
                        ...
                        <h3>Stick it</h3>
                        <p class="w3-text-grey">Notizen verwalten</p>
                    </div>
                </a>
            </div>
            ...
            <div class="w3-third w3-margin-bottom">
                {{-- <a href="{{ route('recipes.index') }}" class="w3-text-black"> --}}
                    <div class="w3-card w3-hover-shadow w3-padding-32 w3-center">
                        ...
                        <h3>Rezepte</h3>
                        <p class="w3-text-grey">Rezepte verwalten</p>
                    </div>
                </a>
            </div>
            ...
            <div class="w3-third w3-margin-bottom">
                <div class="w3-card w3-padding-32 w3-center w3-light-grey">
                    ...
                    <h3 class="w3-text-grey">Bald verfügbar</h3>
                    <p class="w3-text-grey">Weitere Apps folgen</p>
                </div>
            </div>
